...
if /i not "%1"=="pass1" goto :Not_Pass1
    ...
    if not "%SYSGEN_MINGWES%"=="1" goto noMinGWES
       ...
       if not "%SYSGEN_MINGDI%"=="1" goto noMinGDI
          ...
          if "%SYSGEN_PRINTING%"=="1" set GWE2_COMPONENTS=%GWE2_COMPONENTS% mgprint
       ...
       if not "%SYSGEN_MINWMGR%"=="1" goto noMinWMgr
          ...
          if "%__SYSGEN_MOUSE_CURSOR%"=="1" set GWE3_COMPONENTS=%GWE3_COMPONENTS% iconcurs mcursor mcursor8
