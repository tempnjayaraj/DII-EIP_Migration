...
void CBitButton::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
    if(lpDIS->itemAction != ODA_FOCUS)
	{
	    ...
	    EnterCriticalSection(&CUtil::m_DisplayCs);
        pOldBitmap = CUtil::m_hMemoryCDC.SelectObject((lpDIS->itemState & ODS_SELECTED) ? &m_BitmapDown : &m_BitmapUp);
        CUtil::m_hDisplayCDC->BitBlt(tWinRect.left, tWinRect.top, tWinRect.Width(), tWinRect.Height(),
            &CUtil::m_hMemoryCDC, 0, 0, SRCCOPY);
        CUtil::m_hMemoryCDC.SelectObject(pOldBitmap);
	    LeaveCriticalSection(&CUtil::m_DisplayCs);
	}
}
/////////////////////////////////////////////////////////////////////////////
