...
BOOL CHandpieceCountPopUpPortB::OnInitDialog() 
{
    ...
    wHandpieceCountPopUpPortBActive = 1;

	return TRUE;  // return TRUE unless you set the focus to a control
	              // EXCEPTION: OCX Property Pages should return FALSE
}

void CHandpieceCountPopUpPortB::UpdateData()
{
    m_pControl->GetCmdState(GET_MC_PORTB_STATUS, &m_tPortBStatus, sizeof(SN_PORT_STATUS));  
...
{
    wHandpieceCountPopUpPortBActive = 0;
	CDialog::OnOK();
}
...
void CHandpieceCountPopUpPortB::UpdateWindowLockMagnetPositionValue(SnBool yDisplay)
{
    SnQByte lCurrentWindowLockMagnetPositionValue = m_tPortBStatus.wWindowLockMagnetPositionValue;
