...
const External tNoMotor = {
  ...
  0.0f, 0.0f, 1, 1,                                     // Resistance, AccCvrt, TacPerRevN, TacPerRevD
  0.0f, 0.0f, 0,                                        // Accel, Decel, VelMax
  1.0f, 5E-3f, 25.0f,                                   // StopTime, LoopRate, PWMFreq (kHz)
...
const External tPowerMax = {
  ...
  0x3F00, 0xBE20, 0xBB02, 0xBB20, 0xAF08, 0xBE08, 0xAF02, 0x3F00,     // FCommTable[]
  0x3F00, 0xAF02, 0xBE08, 0xAF08, 0xBB20, 0xBB02, 0xBE20, 0x3F00,     // RCommTable[]
  ...
  1.31f, 8.2E-6f, 30, 1,                                // Resistance (Rm+Rs), AccCvrt, TacPerRevN, TacPerRevD
  60000.0f, -60000.0f, 10000,                           // Accel, Decel, VelMax
  0.25f, 5E-3f, 25.0f,                                  // StopTime, LoopRate, PWMFreq (kHz)
...
const External tMaxon16_3_7 = {
  /* Gearmotor: Phase=3 Poles=2 Ke=2.03E-3, Kt=2.47, J=56.2E-6 */
  0x3F00, 0xAF02, 0xBE08, 0xAF08, 0xBB20, 0xBB02, 0xBE20, 0x3F00,     // FCommTable[]
  0x3F00, 0xBE20, 0xBB02, 0xBB20, 0xAF08, 0xBE08, 0xAF02, 0x3F00,     // RCommTable[]
  0x0000, 0x0003, 0x0006, 0x0002, 0x0005, 0x0001, 0x0004, 0x0000,     // FDirTable[]
  0x0000, 0x0005, 0x0003, 0x0001, 0x0006, 0x0004, 0x0002, 0x0000,     // RDirTable[]
  4, 6, 2, 3, 1, 5,                                     // JogTable[]
  1.14f, 3.1E-6f, 22, 1,                                // Resistance (Rm+Rs), AccCvrt, TacPerRevN, TacPerRevD
  60000.0f, -60000.0f, 15000,                           // Accel, Decel, VelMax
  0.25f, 5E-3f, 25.0f,                                  // StopTime, LoopRate, PWMFreq (kHz)
  0.0f, 0.05f, 0.005f, 0.0f, 0.0f, 0.0f,                // Kf, Kp, Ki, Kd, Ka, Kl for velocity
  0.0f, 2.0f, 0.05f, 1.0f, 0.0f, 0.0f,  		        // Kf, Kp, Ki, Kd, Ka, Kl for position
  0.102f, 5,                                            // f(RPM)A-B
  6.25E-2f, 850, 15.0f, 7.5f,                           // TlimA, TlimB, Ilim, Ihigh
...
const External tMaxon19_5_3 = {
  ...
  0x0000, 0x0005, 0x0003, 0x0001, 0x0006, 0x0004, 0x0002, 0x0000,     // RDirTable[]
  4, 6, 2, 3, 1, 5,                                     // JogTable[]
  0.76f, 3.1E-6f, 414, 13,                              // Resistance (Rm+Rs), AccCvrt, TacPerRevN, TacPerRevD
  60000.0f, -60000.0f, 12000,                           // Accel, Decel, VelMax
  0.25f, 5E-3f, 125.0f,                                 // StopTime, LoopRate, PWMFreq (kHz)
  0.0f, 0.02f, 0.01f, 0.0f, 0.0f, 0.0f,                 // Kf, Kp, Ki, Kd, Ka, Kl for velocity 0.0f, 0.05f, 0.05f, 0.05f, 1.0f, 0.0f,
  0.0f, 2.0f, 0.05f, 1.0f, 0.0f, 0.0f,  		            // Kf, Kp, Ki, Kd, Ka, Kl for position 0.0f, 25.0f, 2.5f, 0.5f, 0.0f, 0.0f,
  0.102f, 5,                                            // f(RPM)A-B
  6.25E-2f, 850, 15.0f, 7.5f,                           // TlimA, TlimB, Ilim, Ihigh
...
const External tHiTorque = {
  ...
  0x0000, 0x0005, 0x0003, 0x0001, 0x0006, 0x0004, 0x0002, 0x0000,     // RDirTable[]
  4, 6, 2, 3, 1, 5,                                     // JogTable[]
  0.65f, 16.4E-6f, 60, 1,                               // Resistance, AccCvrt, TacPerRevN, TacPerRevD
  60000.0f, -60000.0f, 5000,                            // Accel, Decel, VelMax
  0.50f, 5E-3f, 25.0f,                                  // StopTime, LoopRate, PWMFreq (kHz)
...
const External tMini = {
  ...
  12.0f, 2.30E-6f, 60, 1,                               // Resistance, AccCvrt, TacPerRevN, TacPerRevD
...
const External tPowerMini = {
  ...
  0x0000, 0x0003, 0x0006, 0x0002, 0x0005, 0x0001, 0x0004, 0x0000,     // RDirTable[]
  5, 1, 3, 2, 6, 4,                                     // JogTable[]
  1.05f, 4.12E-6f, 48, 1,                               // Resistance, AccCvrt, TacPerRevN, TacPerRevD
...
const External tDrill = {
  ...
  0x0000, 0x0005, 0x0003, 0x0001, 0x0006, 0x0004, 0x0002, 0x0000,     // RDirTable[]
  4, 6, 2, 3, 1, 5,                                     // JogTable[]
  2.56f, 3.65E-5f, 218, 1,                              // Resistance, AccCvrt, TacPerRevN, TacPerRevD
  16514.0f, -16514.0f, 2000,                            // Accel, Decel, VelMax
  0.5f, 5E-3f, 25.0f,                                   // StopTime, LoopRate, PWMFreq (kHz)
...
const External tSaw = {
  ...
  0x0000, 0x0005, 0x0003, 0x0001, 0x0006, 0x0004, 0x0002, 0x0000,     // RDirTable[]
  4, 6, 2, 3, 1, 5,                                     // JogTable[]
  2.56f, 1.99E-6f, 12, 1,                               // Resistance, AccCvrt, TacPerRevN, TacPerRevD
...
const External tFactoryTest = {
  ...
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,     // RDirTable[]
  0, 0, 0, 0, 0, 0,                                     // JogTable[]
  0.0f, 0.0f, 30, 1,                                    // Resistance, AccCvrt, TacPerRevN, TacPerRevD
