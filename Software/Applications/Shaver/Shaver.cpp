...
volatile SnWord wReliantLongSerialNumberEnable = 0;
...
DWORD WINAPI ServiceDetectThread(LPVOID pParam)
{
    ...
    do {
        ...
        } else if (GetFileAttributes(FILE_NAME_RELIANT_LONG_SERIAL_NUMBER) != 0xFFFFFFFF) {
            wReliantLongSerialNumberEnable = 1;
        } else {
