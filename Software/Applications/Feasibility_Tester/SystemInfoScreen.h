...
// Dialog Data
    ...
    CStatic m_BtnHandpieceSerialNumberSettingsPortA;
    CStatic m_BtnHandpieceSerialNumberSettingsPortB;
...
protected:
    ...
    afx_msg void OnButtonHandpieceSerialNumberSettingsPortA();
    afx_msg void OnButtonHandpieceSerialNumberSettingsPortB();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private: // helper functions
    ...
    void SetupBitmaps();
    void DrawBitmaps(SnBool bHandpieceSerialNumberFlagPortA, SnBool bHandpieceSerialNumberFlagPortB);            // Load Button Bitmaps. 
...
private: // local member variables
    ...
    CBitmap         m_ButtonOn;
    CBitmap         m_ButtonOff;
    SnBool          m_bHandpieceSerialNumberFlagPortA;
    SnBool          m_bHandpieceSerialNumberFlagPortB;
