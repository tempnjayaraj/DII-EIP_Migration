...
BOOL CSerialNumberPopUp::OnInitDialog() 
{
    ...
    else if(m_wEnteringFromScreen == 1)
    {
        ...
        SetDlgItemText( IDC_STATIC_TITLE, TEXT("Enter Serial Number"));
	    SetDlgItemText( IDC_STATIC_MESSAGE_TEXT, TEXT("Enter the Serial Number via the keypad on the right.\n\nValid Serial Numbers start at 00001 and contain no more than 6 numeric digits.\n\nPress Enter when you are done."));	

        m_csTextPcSerialNumber = CString(m_tPortAStatus.pcSerialNumber,9);
    ...
    else
    {
        ...
        m_csTextPcSerialNumber = CString(m_tPortBStatus.pcSerialNumber,9);
        SetDlgItemText(IDC_STATIC_MESSAGE_TEXT2, m_csTextPcSerialNumber);
    }
...
void CSerialNumberPopUp::AddDigit(char cDigit)
{
    ...
    else if(m_wEnteringFromScreen == 1) 
    {
        ...
        if (len < 9) {
            ...
            m_csTextPcSerialNumber = m_tPortAStatus.pcSerialNumber;
            SetDlgItemText(IDC_STATIC_MESSAGE_TEXT2, m_csTextPcSerialNumber);
        }
    }
    else
    {
        ...
        if (len < 9) {
            ...
            m_csTextPcSerialNumber = m_tPortBStatus.pcSerialNumber;
            SetDlgItemText(IDC_STATIC_MESSAGE_TEXT2, m_csTextPcSerialNumber);
        }
    }
}
