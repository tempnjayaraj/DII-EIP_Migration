...
#define TYPE_MDU_HIGH_TORQUE        3
#define TYPE_MDU_HIGH_TORQUE_CTL    4
#define TYPE_MDU_UTLRA_IUR          5
#define TYPE_MDU_MINI               6
#define TYPE_MDU_TEST               7
#define TYPE_MDU_FAST               8
#define TYPE_MDU_FAST_CTL           9
#define TYPE_MDU_POWERMINI			10
#define TYPE_MDU_POWERMINI_CTL		11

#define IS_TYPE_MDU(x)				((x) >= 1 && (x) <= 11)
...
#define RS485_TYPE_MDU_FAST_CTL			3
#define RS485_TYPE_MDU_FAST 			4
