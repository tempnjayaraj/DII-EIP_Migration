...
#define RS485_FAST_MDU_SUPPORT          1   // RS485 Fast MDU Support
#define RS485_TRACK_ERRORS              0   // RS485 Error Debuging
...
#define FLASH_SAVE_SIZE         (((sizeof(SAVE_DEVICE_DATA)*2)+0x1f)&~0x1f)
...
#define PERCENT_START_THRESHOLD         2		// 2%  depression for Variable
...
//
// Delays in increments ms (include 1 ms task swap time)
//
#define SLEEP_PERIOD_9					   9	// Delay in increments of  9 ms
#define SLEEP_PERIOD_16					  16	// Delay in increments of 16 ms
#define SLEEP_PERIOD_20					  19	// Delay in increments of 20 ms
#define SLEEP_PERIOD_25					  24	// Delay in increments of 25 ms
#define SLEEP_PERIOD_33					  32	// Delay in increments of 33 ms
#define SLEEP_PERIOD_100				  99	// Delay in increments of 100 ms
...
#define NEW_DEVICE_DELAY_MS				 200
...
#define MC_BLDCX_TACPERREV(iPort)       ((iPort == HAND_PORTA)?offsetof(Status_Control,tBldcA.tEx.wTacPerRev)/2:offsetof(Status_Control,tBldcB.tEx.wTacPerRev)/2)
...
public:
    ...
    inline SnBool GetPumpStatus(CPump::PumpType *pePumpType) {if(m_pPumpConnection) return m_pPumpConnection->GetPumpStatus(pePumpType); return FALSE;}
    ...
    SnBool SendSerialRequest(SnWord *pwResults, SnWord wTimeout, CCommandDuration & duration);
